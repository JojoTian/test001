    ...
    r.enc.Base64 = {
        stringify: function(r) {
            ...
            for (var n = [], o = 0; o < t; o += 3)
                for (var i = (e[o >>> 2] >>> 24 - o % 4 * 8 & 255) << 16 | (e[o + 1 >>> 2] >>> 24 - (o + 1) % 4 * 8 & 255) << 8 | e[o + 2 >>> 2] >>> 24 - (o + 2) % 4 * 8 & 255, f = 0; f < 4 && o + .75 * f < t; f++)
        ...
        parse: function(r) {
            ...
            return function(r, e, t) {
                for (var a = [], n = 0, o = 0; o < e; o++)
                    if (o % 4) {
                        var i = t[r.charCodeAt(o - 1)] << o % 4 * 2
